...
class ElevatorSubsystem(Subsystem):
    ...
    def l4(self):
        self.elevatorMotor1.set(-1*self.pidController1.calculate(21.5, self.elevatorEncoder1.getPosition()))
        self.elevatorMotor2.set(-1*self.pidController1.calculate(21.5, self.elevatorEncoder1.getPosition()))
    def l5(self):
    ...
    def down(self):
        ...
        self.elevatorMotor1.set(-1*self.pidController1.calculate(0.5, self.elevatorEncoder1.getPosition()))
        self.elevatorMotor2.set(-1*self.pidController1.calculate(0.5, self.elevatorEncoder1.getPosition()))
